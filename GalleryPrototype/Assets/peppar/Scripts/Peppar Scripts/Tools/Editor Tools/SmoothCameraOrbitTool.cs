...
namespace peppar
{
    [AddComponentMenu("Camera-Control/Smooth Mouse Orbit - Unluck Software - Edited @ ExG")]
    public class SmoothCameraOrbitTool : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            {
                targetOffset.y += Input.GetAxis("Mouse Y") * ySpeed * 0.001f;
                targetOffset.y = ClampAngle(targetOffset.y, -3, 0);
                // set camera rotation
                idleTimer = 0;
                idleSmooth = 0;
            }
